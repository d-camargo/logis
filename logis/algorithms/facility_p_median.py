...
class FacilityPMedian(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        fac_fields.append(QgsField("assigned_count", qgis_compat.field_type("int")))
        fac_fields.append(QgsField("assigned_demand_sum", qgis_compat.field_type("double")))
        fac_fields.append(QgsField("total_weighted_cost", qgis_compat.field_type("double")))
