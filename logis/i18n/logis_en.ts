...
<context>
    ...
    <message>
        ...
        <source>Algoritmo '{self.alg_id}' não encontrado.</source>
        <translation type="obsolete">Algorithm '{self.alg_id}' not found in the Processing registry.</translation>
    </message>
    <message>
        <location filename="../gui/task_runner.py" line="52"/>
        <source>Algoritmo {id} não encontrado no registro do Processing.</source>
        <translation>Algorithm {id} not found in the Processing registry.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Municipality name (optional)</translation>
    </message>
    <message>
...
- Nós (rede viária): camada de pontos representando as interseções e extremidades dos arcos.</source>
        <translation type="obsolete">Downloads and processes the urban road network of a municipality from OpenStreetMap data (via Overpass API).

Parameters:
- Municipal IBGE code: 7-digit numeric code.
- Municipality name (optional): to help identification.
- Force new download: if true, ignores local cache and makes a new Overpass request.

Returns:
- Links (road network): line layer representing road segments clipped for the municipality.
- Nodes (road network): point layer representing intersections and endpoints.</translation>
    </message>
    <message>
        <location filename="../algorithms/data_osm_network.py" line="110"/>
        <source>Fonte: {backend}</source>
        <translation>Source: {backend}</translation>
    </message>
    <message>
...
- Arcos (rede viária): camada de linhas representando os trechos de vias recortados para o município.
- Nós (rede viária): camada de pontos representando as interseções e extremidades dos arcos.</source>
        <translation>Downloads and processes the urban road network of a municipality from OpenStreetMap data.
Uses the algorithm gisbr:osm_network when GisBR 0.11+ is installed and the internal pipeline otherwise.
In both cases, links include the cost fields length, speed and travel_time.

Parameters:
- IBGE municipality code: 7-digit numerical code.
- Municipality name (optional): to assist in identification.
- Force new download: if true, ignores local cache and makes a new Overpass request.

Returns:
- Links (road network): line layer representing road segments clipped for the municipality.
- Nodes (road network): point layer representing intersections and link endpoints.</translation>
    </message>
</context>
<context>
    <name>LoadSnvNetwork</name>
    <message>
        <location filename="../algorithms/data_snv_network.py" line="44"/>
        <source>Sigla da UF (2 letras)</source>
        <translation>State abbreviation (2 letters)</translation>
    </message>
    <message>
        <location filename="../algorithms/data_snv_network.py" line="50"/>
        <source>Forçar novo download (ignorar cache)</source>
        <translation>Force new download (ignore cache)</translation>
    </message>
    <message>
        <location filename="../algorithms/data_snv_network.py" line="57"/>
        <source>Arcos (rede viária)</source>
        <translation>Links (road network)</translation>
    </message>
    <message>
        <location filename="../algorithms/data_snv_network.py" line="63"/>
        <source>Nós (rede viária)</source>
        <translation>Nodes (road network)</translation>
    </message>
    <message>
        <location filename="../algorithms/data_snv_network.py" line="76"/>
        <source>UF inválida: {uf}</source>
        <translation>Invalid state: {uf}</translation>
    </message>
    <message>
        <location filename="../algorithms/data_snv_network.py" line="99"/>
        <source>O SNV não devolveu dados para a UF {uf}.</source>
        <translation>SNV did not return data for state {uf}.</translation>
    </message>
    <message>
        <location filename="../algorithms/data_snv_network.py" line="111"/>
        <source>Não foi possível criar o sink de arcos.</source>
        <translation>Could not create links sink.</translation>
    </message>
    <message>
        <location filename="../algorithms/data_snv_network.py" line="122"/>
        <source>Não foi possível criar o sink de nós.</source>
        <translation>Could not create nodes sink.</translation>
    </message>
    <message>
        <location filename="../algorithms/data_snv_network.py" line="143"/>
        <source>Rede viária SNV carregada: {links} arcos, {nodes} nós.</source>
        <translation>SNV road network loaded: {links} links, {nodes} nodes.</translation>
    </message>
    <message>
        <location filename="../algorithms/data_snv_network.py" line="160"/>
        <source>Baixar rede viária federal (SNV/DNIT, UF)</source>
        <translation>Download federal road network (SNV/DNIT, state)</translation>
    </message>
    <message>
        <location filename="../algorithms/data_snv_network.py" line="163"/>
        <source>Dados</source>
        <translation>Data</translation>
    </message>
    <message>
        <location filename="../algorithms/data_snv_network.py" line="169"/>
        <source>Baixa e processa a rede viária federal de uma UF a partir dos dados do SNV/DNIT.
...
- Nós (rede viária): camada de pontos representando as interseções e extremidades dos arcos.</source>
        <translation>Downloads and processes the federal road network of a state from SNV/DNIT data.

Parameters:
- State abbreviation (2 letters): Brazilian state abbreviation (e.g., MG, SP, RJ).
- Force new download: if true, ignores local cache and makes a new request.

Returns:
- Links (road network): line layer representing federal/state highway segments in the state.
- Nodes (road network): point layer representing intersections and endpoints.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <source>Fonte: Pipeline interno (logis)</source>
...
<context>
    ...
    <message>
        ...
        <translation type="obsolete">Select origin, visit points, and road network layers to calculate optimized route (Traveling Salesperson Problem - TSP).</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>QGIS Processing não está disponível no ambiente atual.</source>
        <translation type="obsolete">QGIS Processing is not available in the current environment.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">-&gt; &lt;b&gt;Total tour distance:&lt;/b&gt; {dist:.2f}</translation>
    </message>
    <message>
        <location filename="../gui/routing_dock.py" line="374"/>
        <source>-&gt; &lt;b&gt;Custo de acesso:&lt;/b&gt; {acc:.2f}</source>
        <translation type="obsolete">-&gt; &lt;b&gt;Access cost:&lt;/b&gt; {acc:.2f}</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">The panel brings together Traveling Salesperson and Capacitated Vehicle Routing; the road network layer chosen below applies to both tabs.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Note: The road network layer used is the one selected at the top of the panel.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>The panel brings together Traveling Salesperson and Capacitated Vehicle Routing; the road network layer selected below applies to the CVRP tab and, in the TSP tab, when the &quot;via road network&quot; mode is selected.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Distance calculation mode:</translation>
    </message>
    <message>
        <location filename="../gui/routing_dock.py" line="362"/>
        <source>Linha reta (euclidiana)</source>
        <translation>Straight line (Euclidean)</translation>
    </message>
    <message>
        <location filename="../gui/routing_dock.py" line="362"/>
        <source>Pela rede viária (Dijkstra)</source>
        <translation>Via road network (Dijkstra)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="../gui/urban_dock.py" line="727"/>
    ...
    <message>
        <location filename="../gui/urban_dock.py" line="751"/>
        <source>Erro</source>
        <translation>Error</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../gui/urban_dock.py" line="712"/>
    ...
    <message>
        <location filename="../gui/urban_dock.py" line="771"/>
    ...
    <message>
        <location filename="../gui/urban_dock.py" line="775"/>
    ...
    <message>
        <location filename="../gui/urban_dock.py" line="777"/>
...
<context>
    ...
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="51"/>
        <source>Camada de rede viária (Linhas)</source>
        <translation>Road network layer (Lines)</translation>
    </message>
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="58"/>
        <source>Número de amostras (pares OD)</source>
        <translation>Number of samples (OD pairs)</translation>
    </message>
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="67"/>
        <source>Distância euclidiana mínima (metros)</source>
        <translation>Minimum euclidean distance (meters)</translation>
    </message>
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="76"/>
        <source>Circuidade média</source>
        <translation>Average circuity</translation>
    </message>
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="89"/>
        <source>Camada de rede viária inválida.</source>
        <translation>Invalid road network layer.</translation>
    </message>
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="91"/>
        <source>Construindo o grafo a partir da rede viária...</source>
        <translation>Building graph from road network...</translation>
    </message>
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="95"/>
        <source>Erro ao construir o grafo: {}</source>
        <translation>Error building graph: {}</translation>
    </message>
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="101"/>
    ...
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="105"/>
        <source>Grafo construído: {v} vértices, {e} arestas.</source>
        <translation>Graph built: {v} vertices, {e} edges.</translation>
    </message>
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="111"/>
    ...
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="169"/>
    ...
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="176"/>
    ...
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="187"/>
        <source>Circuidade média calculada: {circuity:.4f}</source>
        <translation>Average circuity calculated: {circuity:.4f}</translation>
    </message>
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="196"/>
        <source>Circuidade Média de Rede Viária Urbana</source>
        <translation>Average Circuity of Urban Road Network</translation>
    </message>
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="199"/>
        <source>Indicadores Urbanos</source>
        <translation>Urban Indicators</translation>
    </message>
    <message>
        <location filename="../algorithms/urban_mean_circuity.py" line="205"/>
...
<context>
    ...
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="133"/>
        <source>Camada de rede viária (Linhas) (opcional)</source>
        <translation>Road network layer (Lines) (optional)</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="141"/>
        <source>Aplicar busca local (2-opt e Or-opt)</source>
        <translation>Apply local search (2-opt and Or-opt)</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="160"/>
    ...
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="191"/>
        <source>Camada de depósito inválida.</source>
        <translation>Invalid depot layer.</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="193"/>
        <source>Camada de demanda inválida.</source>
        <translation>Invalid demand layer.</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="195"/>
    ...
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="227"/>
        <source>Lendo pontos de demanda...</source>
        <translation>Reading demand points...</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="271"/>
        <source>Nenhum ponto de demanda válido encontrado.</source>
        <translation>No valid demand point found.</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="282"/>
        <source>Construindo o grafo e calculando a matriz OD na rede...</source>
        <translation>Building graph and calculating network OD matrix...</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="302"/>
        <source>Erro ao construir o grafo: {}</source>
        <translation>Error building graph: {}</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="309"/>
        <source>O grafo construído possui menos de 2 vértices.</source>
        <translation>The constructed graph has fewer than 2 vertices.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">Running CVRP optimization (Clarke-Wright + 2-opt/Or-opt)...</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="474"/>
...
- Paradas por rota: camada de pontos ordenada com atribuição de rota e carga acumulada.</source>
        <translation type="obsolete">Builds routes starting and ending at the depot while respecting maximum vehicle capacity, using Clarke &amp; Wright (1964) savings heuristic and optional local search refinement via 2-opt (Lin, 1965) and Or-opt (Or, 1976).
...
- Stops per route: ordered point layer with route assignment and cumulative payload.</translation>
    ...
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="148"/>
        <source>Backend de otimização</source>
        <translation>Optimization backend</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="226"/>
        <source>Lendo pontos de demanda…</source>
        <translation>Reading demand points…</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="294"/>
    ...
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="316"/>
        <source>Calculando a matriz OD…</source>
        <translation>Calculating OD matrix…</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="332"/>
        <source>Calculando matriz de distâncias euclidianas…</source>
        <translation>Calculating Euclidean distance matrix…</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="348"/>
        <source>Otimizando (OR-Tools)…</source>
        <translation>Optimizing (OR-Tools)…</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="350"/>
    ...
    <message>
        <location filename="../algorithms/vrp_cvrp.py" line="376"/>
...
Parameters:
- Depot layer: point/polygon feature representing the start/end depot.
- Demand / customer layer: point or polygon features with demands to be served.
- Weight/demand field: numeric demand field for each customer (optional, default=1.0).
- Vehicle capacity: maximum payload transported by each vehicle per route.
- Road network layer: road network for actual distances (optional, uses Euclidean distance if omitted).
- Apply local search: if true, applies 2-opt and Or-opt to optimize each route.
- Optimization backend: solver choice (Automatic/Python/OR-Tools).

Outputs:
- Generated routes: line layer with route geometry and load/distance statistics.
...
<context>
    ...
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="132"/>
        <source>Camada de pontos a visitar</source>
        <translation>Points to visit layer</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="139"/>
    ...
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="147"/>
        <source>Camada de rede viária (Linhas) (opcional)</source>
        <translation>Road network layer (Lines) (optional)</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="174"/>
        <source>Ordem de visita</source>
        <translation>Visit order</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="180"/>
        <source>Rota (trechos)</source>
        <translation>Route (legs)</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="204"/>
    ...
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="237"/>
    ...
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="267"/>
    ...
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="283"/>
        <source>Construindo o grafo e calculando a matriz OD na rede...</source>
    ...
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="336"/>
        <source>Erro ao calcular a matriz OD: {}</source>
        <translation>Error computing OD matrix: {}</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="355"/>
        <source>Calculando matriz de distâncias euclidianas...</source>
    ...
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="600"/>
        <source>Caixeiro Viajante (TSP)</source>
        <translation>Traveling Salesperson (TSP)</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="603"/>
        <source>Roteirização</source>
        <translation>Routing</translation>
    </message>
    <message>
...
- Rota (trechos): camada de linhas com a geometria das pernas da rota classificadas ('leg_role': 'acesso', 'rota', 'retorno'). Os trechos 'acesso' e 'retorno' da camada de rota são os deslocamentos improdutivos (do ponto inicial ao primeiro ponto a visitar e do último ao ponto final), somados em 'access_dist' e 'return_dist', com os totais de distância ('tour_dist', 'service_dist') e a taxa improdutiva ('dead_ratio') repetidos em todas as feições.</source>
        <translation type="obsolete">Solves the Traveling Salesperson Problem (TSP) from a start point, a points to visit layer, and optionally an end point or road network.
...
- Route (legs): line layer with leg geometries classified ('leg_role': 'acesso', 'rota', 'retorno'). 'acesso' and 'retorno' legs represent deadhead movements (from start point to first visit point and from last to end point), summed in 'access_dist' and 'return_dist', with distance totals ('tour_dist', 'service_dist') and deadhead ratio ('dead_ratio') repeated across all features.</translation>
    ...
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="162"/>
        <source>Backend de otimização</source>
        <translation>Optimization backend</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="236"/>
        <source>Lendo pontos a visitar…</source>
        <translation>Reading points to visit…</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="295"/>
        <source>Janela de análise: {}</source>
        <translation>Analysis window: {}</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="299"/>
        <source>Construindo o grafo…</source>
        <translation>Building graph…</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="316"/>
    ...
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="346"/>
    ...
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="370"/>
        <source>Otimizando (OR-Tools)…</source>
        <translation>Optimizing (OR-Tools)…</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="372"/>
        <source>Otimizando (heurística Python)…</source>
        <translation>Optimizing (Python heuristic)…</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="403"/>
        <source>Gravando as saídas…</source>
        <translation>Writing outputs…</translation>
    </message>
    <message>
        <location filename="../algorithms/vrp_tsp.py" line="609"/>
        <source>Resolve o Problema do Caixeiro Viajante (TSP) a partir de um ponto inicial, uma camada de pontos a visitar e, opcionalmente, um ponto final ou rede viária.
...
Saídas:
- Ordem de visita: camada de pontos ordenada com a ordem de visita na tabela de atributos em 'visit_seq', nó ('node_role'), papel da perna ('leg_role'), distância da perna ('leg_dist') e distância acumulada ('cum_dist').
- Rota (trechos): camada de linhas com a geometria das pernas da rota classificadas ('leg_role': 'acesso', 'rota', 'retorno'). Os trechos 'acesso' e 'retorno' da camada de rota são os deslocamentos improdutivos (do ponto inicial ao primeiro ponto a visitar e do último ao ponto final), somados em 'access_dist' e 'return_dist', com os totais de distância ('tour_dist', 'service_dist') e a taxa improdutiva ('dead_ratio') repetidos em todas as feições, além do modo de cálculo ('dist_mode') e da geometria do trecho ('leg_geom').</source>
        <translation>Solves the Traveling Salesperson Problem (TSP) from a start point layer, a points to visit layer, and optionally an end point layer or road network.

Determines the visit sequence with minimum total distance using Nearest Neighbor heuristics (Flood, 1956) with optional local search refinement via 2-opt (Lin, 1965) and Or-opt (Or, 1976), or Google OR-Tools constraint programming solver.

Parameters:
- Start point layer: point/polygon feature for departure location.
- Points to visit layer: point/polygon features to visit.
- End point layer (optional): feature for arrival location (if omitted or empty, route closes at start point).
- Road network layer: road network for actual distances (optional, uses Euclidean distance if omitted).
- Apply local search: if true, applies 2-opt and Or-opt for route optimization.
- Optimization backend: solver choice ('Automatic (OR-Tools when available)', 'Pure Python (heuristic)' or 'OR-Tools'). 'Pure Python' mode is safe if QGIS crashes when running routes.

Outputs:
- Visit order: ordered point layer with visit sequence in attribute table ('visit_seq'), node role ('node_role'), leg role ('leg_role'), leg distance ('leg_dist'), and cumulative distance ('cum_dist').
...
<context>
    ...
    <message>
        ...
        <translation type="obsolete">OSM road network ({code_muni}) loaded: {n_links} links, {n_nodes} nodes.</translation>
    </message>
    <message>
